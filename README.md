# Streamly — Full-Stack Video Streaming App

Streamly is a full-featured video streaming web application built with the **MERN stack** (MongoDB, Express.js, React.js, Node.js). It allows users to register, upload and manage videos, interact with content, and engage with other users.
